...
class IntentDetector:
    ...
    RULES = {
        ...
        IntentType.WEB_SEARCH: [
            ...
            r"в интернете", r"погугли", r"сеть", r"duckduckgo",
            r"новости", r"погода", r"найди в сети", r"поищи в",
            r"выдай из интернета", r"спроси интернет", r"загугли",
            r"web search", r"search online", r"look up", r"google",
            # Актуальные данные — триггеры для реального времени
            r"актуальн", r"курс (?:доллар|евро|рубл|валют)",
            r"сегодн", r"сейчас", r"в реальном времени",
            r"последн", r"свеж", r"текущ", r"новейш",
            r"сколько сейчас", r"какой сейчас",
            r"посмотри в сети", r"узнай в интернете",
            r"что говорят", r"что нового",
        ],
