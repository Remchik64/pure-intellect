...
from .api.system import openai_router
...
async def version_info():
    ...
    try:
        ver = importlib.metadata.version("contextor")
    except Exception:
        ver = "dev"
...
async def startup():
    ...
    logger.info("🧠 Contextor запускается...")
...
async def shutdown():
    ...
    manager.dispose()
    logger.info("🧠 Contextor остановлен, VRAM освобождена")
